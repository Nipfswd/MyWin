//
// msg.h - messages, tokens, etc. are gathered here to make localization easier
//
// STR_ are thngs that maybe don't get localized (comamnd tokens)
...
#define STR_MSRES       L"MSRES"        // NoahBajsToa Reserved
#define MSG_MSRES       L"NoahBajsToa Reserved partition for feature support"
...
#define MSG_MSDATA      L"User data partition for use by NoahBajsToa OSes"
